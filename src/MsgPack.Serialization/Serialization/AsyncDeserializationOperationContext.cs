...
namespace MsgPack.Serialization
{
	public sealed partial class AsyncDeserializationOperationContext
	{
		...
		public Encoding? StringEncoding => this.Options.DefaultStringEncoding;
		...
		public int IncrementDepth()
		{
			...
			{
				CoreThrow.DepthExeeded(this.CurrentDepth, this.Options.MaxDepth);
			}
		...
		public void ValidatePropertyKeyLength(long position, int length)
		{
			...
			{
				CoreThrow.TooLargePropertyKey(position, length, this.Options.MaxPropertyKeyLength);
			}
		}
	}
}
