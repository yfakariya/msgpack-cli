...
{
	[TestFixture]
	public partial class UnpackingTest_Combinations_Int32
	{
		[Test]
		public void TestUnpackInt32_ByteArray_Int64MinValueAsInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xD3, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		...
		public void TestUnpackInt32_Stream_Int64MinValueAsInt64_AsIs()
		{
			...
			{
				Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( buffer ) );
			}
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValueAsInt8_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD0, 0x7F } );
			Assert.That( result.ReadCount, Is.EqualTo( 2 ) );
			Assert.That( result.Value, Is.EqualTo( 127L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValueAsInt8_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValueAsUInt8_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCC, 0x7F } );
			Assert.That( result.ReadCount, Is.EqualTo( 2 ) );
			Assert.That( result.Value, Is.EqualTo( 127L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValueAsUInt8_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValueAsPositiveFixNum127_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0x7F } );
			Assert.That( result.ReadCount, Is.EqualTo( 1 ) );
			Assert.That( result.Value, Is.EqualTo( 127L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValueAsPositiveFixNum127_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsUInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsUInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD2, 0x00, 0x00, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsUInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCE, 0x00, 0x00, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsUInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD1, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsUInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCD, 0x00, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsUInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_PositiveFixNumMaxValuePlusOneAsUInt8_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCC, 0x80 } );
			Assert.That( result.ReadCount, Is.EqualTo( 2 ) );
			Assert.That( result.Value, Is.EqualTo( 128L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_PositiveFixNumMaxValuePlusOneAsUInt8_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsUInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsUInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD2, 0x00, 0x00, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsUInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCE, 0x00, 0x00, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsUInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD1, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsUInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCD, 0x00, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsUInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValueAsUInt8_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCC, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 2 ) );
			Assert.That( result.Value, Is.EqualTo( 255L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValueAsUInt8_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsUInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsUInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD2, 0x00, 0x00, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsUInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCE, 0x00, 0x00, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsUInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD1, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_ByteMaxValuePlusOneAsUInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCD, 0x01, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 256L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_ByteMaxValuePlusOneAsUInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValueAsInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 65535L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValueAsInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValueAsUInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 65535L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValueAsUInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValueAsInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD2, 0x00, 0x00, 0xFF, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 65535L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValueAsInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValueAsUInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCE, 0x00, 0x00, 0xFF, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 65535L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValueAsUInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValueAsUInt16_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCD, 0xFF, 0xFF } );
			Assert.That( result.ReadCount, Is.EqualTo( 3 ) );
			Assert.That( result.Value, Is.EqualTo( 65535L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValueAsUInt16_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValuePlusOneAsInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 65536L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValuePlusOneAsInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValuePlusOneAsUInt64_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 9 ) );
			Assert.That( result.Value, Is.EqualTo( 65536L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValuePlusOneAsUInt64_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValuePlusOneAsInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xD2, 0x00, 0x01, 0x00, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 65536L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValuePlusOneAsInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt16MaxValuePlusOneAsUInt32_Fail()
		{
			var result = Unpacking.UnpackInt32( new byte[] { 0xCE, 0x00, 0x01, 0x00, 0x00 } );
			Assert.That( result.ReadCount, Is.EqualTo( 5 ) );
			Assert.That( result.Value, Is.EqualTo( 65536L ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt16MaxValuePlusOneAsUInt32_Fail()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt32MaxValueAsInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt32MaxValueAsInt64_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt32MaxValueAsUInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt32MaxValueAsUInt64_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt32MaxValueAsUInt32_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xCE, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt32MaxValueAsUInt32_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt32MaxValuePlusOneAsInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt32MaxValuePlusOneAsInt64_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt32MaxValuePlusOneAsUInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt32MaxValuePlusOneAsUInt64_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_UInt64MaxValueAsUInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xCF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		
		[Test]
		public void TestUnpackInt32_Stream_UInt64MaxValueAsUInt64_AsIs()
		{
		...
		[Test]
		public void TestUnpackInt32_ByteArray_Empty()
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt32( new byte[ 0 ] ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt32( default( byte[] ) ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Offset_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt32( default( byte[] ), 0 ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Offset_OffsetIsNegative()
		{
			Assert.Throws<ArgumentOutOfRangeException>( () => Unpacking.UnpackInt32( new byte[]{ 0x1 }, -1 ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Offset_OffsetIsTooBig()
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt32( new byte[]{ 0x1 }, 1 ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Offset_Empty()
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt32( new byte[ 0 ], 0 ) );
		}

		[Test]
		public void TestUnpackInt32_Stream_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt32( default( Stream ) ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Offset_OffsetIsValid_OffsetIsRespected()
		{
			// Offset 1 is positive fix num 1.
			var result = Unpacking.UnpackInt32( new byte[] { 0xFF, 0x57, 0xFF }, 1 );
			Assert.That( result.ReadCount, Is.EqualTo( 1 ) );
			Assert.That( result.Value, Is.EqualTo( 0x57 ) );
		}

		[Test]
		public void TestUnpackInt32_ByteArray_Null_Nil()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xC0 } ) );
		}
	
		[Test]
		public void TestUnpackInt32_ByteArray_NotInt32()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt32( new byte[] { 0xA0 } ) );
		}
	}
}
