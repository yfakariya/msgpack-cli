...
{
	[TestFixture]
	public partial class UnpackingTest_Combinations_Int16
	{
		[Test]
		public void TestUnpackInt16_ByteArray_Int64MinValueAsInt64_AsIs()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		...
		public void TestUnpackInt16_Stream_Int64MinValueAsInt64_AsIs()
		{
			...
			{
				Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( buffer ) );
			}
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0x80, 0x00, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD2, 0x80, 0x00, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD2, 0xFF, 0xFF, 0x7F, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD2, 0x00, 0x00, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCE, 0x00, 0x00, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCD, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD2, 0x00, 0x01, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCE, 0x00, 0x01, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCE, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xD3, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCF, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00 } ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xCF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } ) );
		}
		...
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt16( new byte[ 0 ] ) );
		}

		[Test]
		public void TestUnpackInt16_ByteArray_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt16( default( byte[] ) ) );
		}

		[Test]
		public void TestUnpackInt16_ByteArray_Offset_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt16( default( byte[] ), 0 ) );
		}

		[Test]
		public void TestUnpackInt16_ByteArray_Offset_OffsetIsNegative()
		{
			Assert.Throws<ArgumentOutOfRangeException>( () => Unpacking.UnpackInt16( new byte[]{ 0x1 }, -1 ) );
		}

		[Test]
		public void TestUnpackInt16_ByteArray_Offset_OffsetIsTooBig()
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt16( new byte[]{ 0x1 }, 1 ) );
		}

		[Test]
		public void TestUnpackInt16_ByteArray_Offset_Empty()
		{
			Assert.Throws<ArgumentException>( () => Unpacking.UnpackInt16( new byte[ 0 ], 0 ) );
		}

		[Test]
		public void TestUnpackInt16_Stream_Null()
		{
			Assert.Throws<ArgumentNullException>( () => Unpacking.UnpackInt16( default( Stream ) ) );
		}
		...
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xC0 } ) );
		}
	
		[Test]
		public void TestUnpackInt16_ByteArray_NotInt16()
		{
			Assert.Throws<MessageTypeException>( () => Unpacking.UnpackInt16( new byte[] { 0xA0 } ) );
		}
	}
}
